// Basado en el código de Patrick Catanzariti que se puede encontrar en 
...
static void init_location_search(Window *window) {
  ...
  text_layer_set_text(label_layer, "Estas en:");
  ...
  text_layer_set_text(text_layer, "Cargando...");
  ...
  Tuplet initial_values[] = {
     TupletCString(OUR_LOCATION, "Cargando...")
  };
